...
ActiveRecord::Schema.define(version: 20170118003801) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["private_profile"], name: "index_users_on_private_profile", using: :btree
